...
let msg = prompt("Você gostaria de aprender mais uma tecnologia? Digite 'ok' em caso positivo.");
while (msg === "ok"){
    let tecnologiaDesejada = prompt("Qual?");
    alert(`${tecnologiaDesejada} é realmente uma tecnologia bem maneirinha! :D`)
